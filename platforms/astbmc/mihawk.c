...
const struct platform_ocapi mihawk_ocapi = {
	.i2c_engine          = 1,
	.i2c_port            = 4,
	.i2c_reset_addr      = 0x20,
...
{
	if (!dt_node_is_compatible(dt_root, "wistron,mihawk"))
		return false;
...
static const struct bmc_hw_config bmc_hw_mihawk = {
...
static const struct bmc_platform bmc_mihawk_openbmc = {
	.name			= "zaius:openbmc",
	.hw			= &bmc_hw_mihawk,
	.sw			= &bmc_sw_openbmc,
};
